...
class SimpleConfig(Logger):
    ...
    def convert_version_3(self):
        ...
        if isinstance(base_unit, str):
            ...
            map_ = {'grlc':8, 'mgrlc':5, 'ugrlc':2, 'knobs':2, 'clo':0}
    ...
    def get_fee_text(
        ...
        if fee_per_kb is None:
            ...
            rate_str = format_fee_satoshis(fee_per_byte) + ' clo/byte'
    ...
    def format_fee_rate(self, fee_rate):
        return format_fee_satoshis(fee_rate/1000, num_zeros=self.num_zeros) + ' clo/byte'
